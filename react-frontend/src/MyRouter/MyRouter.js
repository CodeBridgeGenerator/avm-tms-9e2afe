...
import SingleTicketCollectionDetailsPage from "../components/app_components/TicketCollectionDetailsPage/SingleTicketCollectionDetailsPage";
import TicketCollectionDetailProjectLayoutPage from "../components/app_components/TicketCollectionDetailsPage/TicketCollectionDetailProjectLayoutPage";
import SingleUserChecklistDetailsPage from "../components/app_components/UserChecklistDetailsPage/SingleUserChecklistDetailsPage";
import UserChecklistDetailProjectLayoutPage from "../components/app_components/UserChecklistDetailsPage/UserChecklistDetailProjectLayoutPage";
import SingleTimerDetailsPage from "../components/app_components/TimerDetailsPage/SingleTimerDetailsPage";
import TimerDetailProjectLayoutPage from "../components/app_components/TimerDetailsPage/TimerDetailProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/ticketCollectionDetails/:singleTicketCollectionDetailsId" exact element={<SingleTicketCollectionDetailsPage />} />
<Route path="/ticketCollectionDetails" exact element={<TicketCollectionDetailProjectLayoutPage />} />
<Route path="/userChecklistDetails/:singleUserChecklistDetailsId" exact element={<SingleUserChecklistDetailsPage />} />
<Route path="/userChecklistDetails" exact element={<UserChecklistDetailProjectLayoutPage />} />
<Route path="/timerDetails/:singleTimerDetailsId" exact element={<SingleTimerDetailsPage />} />
<Route path="/timerDetails" exact element={<TimerDetailProjectLayoutPage />} />
