...
{
                  icon: <Home />,
                  label: "TicketCollectionDetails",
                  menuKey: "ticketCollectionDetails",
                  to: "/ticketCollectionDetails",
                },
{
                  icon: <Home />,
                  label: "UserChecklistDetails",
                  menuKey: "userChecklistDetails",
                  to: "/userChecklistDetails",
                },
{
                  icon: <Home />,
                  label: "TimerDetails",
                  menuKey: "timerDetails",
                  to: "/timerDetails",
                },
                                    /* ~cb-add-menu~ */
                                ]
