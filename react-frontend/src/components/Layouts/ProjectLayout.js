...
import TicketCollectionDetailsPage from "../TicketCollectionDetailsPage/TicketCollectionDetailsPage";
...
case "products":
                return <ProductsPage />;
case "ticketCollectionDetails":
                return <TicketCollectionDetailsPage />;
