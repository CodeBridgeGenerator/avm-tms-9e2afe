...
import seederData from "./ticketCollectionDetails.seeder.json";
...
const TicketCollectionDetailsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TicketCollectionDetailsSeederDialogComponent);
