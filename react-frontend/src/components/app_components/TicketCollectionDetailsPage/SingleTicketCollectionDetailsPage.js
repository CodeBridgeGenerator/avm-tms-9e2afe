...
const SingleTicketCollectionDetailsPage = (props) => {
...
const [userMailAddress, setUserMailAddress] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleTicketCollectionDetailsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
...
const userMailAddress = Array.isArray(res.userMailAddress)
    ...
    }, [props,urlParams.singleTicketCollectionDetailsId]);


    const goBack = () => {
        navigate("/ticketCollectionDetails");
    };
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                <div className="flex align-items-center">
                    ...
                    <h3 className="m-0">TicketCollectionDetails</h3>
                    <SplitButton
                ...
                {/* <p>ticketCollectionDetails/{urlParams.singleTicketCollectionDetailsId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">TicketIssue</label><p className="m-0 ml-3" >{_entity?.ticketIssue}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">TicketStatus</label><p className="m-0 ml-3" >{_entity?.ticketStatus}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">UserMailAddress</label>
      ...
      <CommentsSection
        recordId={urlParams.singleTicketCollectionDetailsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleTicketCollectionDetailsPage);
