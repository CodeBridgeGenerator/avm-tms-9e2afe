...
const ticketCollectionDetails = require("./ticketCollectionDetails/ticketCollectionDetails.service.js");
const userChecklistDetails = require("./userChecklistDetails/userChecklistDetails.service.js");
const timerDetails = require("./timerDetails/timerDetails.service.js");
...
module.exports = function (app) {
  ...
  app.configure(ticketCollectionDetails);
  app.configure(userChecklistDetails);
  app.configure(timerDetails);
